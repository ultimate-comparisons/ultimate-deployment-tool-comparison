...
/***/ function(module, exports, __webpack_require__) {
	...
	let ComparisonConfigService = class ComparisonConfigService {
	    constructor(title, http, comparisonDataService, comparisonService) {
	        ...
	        this.displayDetailsTooltips = false;
	    }
	    loadTableData(cd) {
